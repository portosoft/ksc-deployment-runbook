...
- **Versão**: PostgreSQL 16 (recomendado para performance e suporte a longo prazo).
...
## Premissas de Design
- **Estabilidade**: Uso de distros RHEL-compliant (Rocky/Oracle) para suporte enterprise.
