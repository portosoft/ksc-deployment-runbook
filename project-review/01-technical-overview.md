...
| Segurança | Vault com chave 0600, geração sintética de credenciais, CodeQL/Semgrep/baseline de segredos ativos | `.github/workflows/`, `automation/lib/vault.py` | `.env` em texto claro permanece suportado | [#237](https://github.com/portosoft/ksc-deployment-runbook/issues/237) |
