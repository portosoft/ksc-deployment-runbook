...
def main():
    ...
    try:
        ...
        stdin, stdout, stderr = client.exec_command("sudo -S cp /tmp/ksc-web-console-setup.json /etc/ksc-web-console-setup.json")
        stdin.write(password + "\n")
        stdin.flush()
        stdout.read() # Wait for completion

        # Check permissions
        stdin, stdout, stderr = client.exec_command("ls -la /etc/ksc-web-console-setup.json")
        print("File details:")
