...
print("Checking old opt and varopt backup folders...")
shell.send("ls -la /root/ksc_evidence_final/opt_kaspersky_20260518_1208/ /root/ksc_evidence_final/varopt_kaspersky_20260518_1208/\n")
time.sleep(2)
out = shell.recv(65536).decode('utf-8', errors='replace')
print("Old backups content:")
print(out)
