  ...
  "openAPIServers": [
    {
      ...
      "openApiPort": 13299
        ...
        cmd_create_json = f"sudo -S bash -c \"echo '{setup_json}' > /etc/ksc-web-console-setup.json\""
        ...
        cmd_install = "sudo -S rpm -ivh /home/suporte/ksc-web-console-16.2.11309.x86_64.rpm"
