...
combinations = [
    ("kscadmin2", "r8hk@bCo^53bNbDt"),
    ("kscadmin", "r8hk@bCo^53bNbDt"),
    ("kscadmin", "Ksc@2026"),
    ("KLAdmins", "Ksc@2026"),
    ("KLAdmins", "r8hk@bCo^53bNbDt"),
    ("suporte", "p1WuCxrARN9WR0U0Meq4xmi*QUsI^#aZ"),
    ("suporte", "Ksc@2026"),
    ("kscadmin", "Porto@2024!"),
]
...
"""
        ...
        stdin, stdout, stderr = client.exec_command("cat > /tmp/test_login_combinations.py")
        ...
        stdin, stdout, stderr = client.exec_command("python3 /tmp/test_login_combinations.py")
