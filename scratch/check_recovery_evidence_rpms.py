...
print("Checking old klnagent64 and web-console setups in recovery evidence...")
shell.send("find /root/ksc_recovery_evidence/ -name '*klnagent*.rpm' -o -name '*web-console*.rpm'\n")
time.sleep(2)
out = shell.recv(65536).decode('utf-8', errors='replace')
print("RPMs in ksc_recovery_evidence:")
print(out)
