...
shell.send("wget https://products.s.kaspersky-labs.com/administrationkit/ksc10/16.2.0.1023/portuguese-BR-29665499-pt-BR/d98c7361838b447c97ec6bd847b9103d/klnagent64-16.2.0-1023.x86_64.rpm -O /home/suporte/klnagent64-16.2.0-1023.x86_64.rpm\n")
time.sleep(5)
out = shell.recv(65536).decode('utf-8', errors='replace')
print("klnagent download:")
print(out)

shell.send("wget https://products.s.kaspersky-labs.com/administrationkit/ksc10/16.2.0.1023/portuguese-BR-29665499-pt-BR/fec0022d4fdf4ee48d1a16616239103d/ksc-web-console-16.2.11309.x86_64.rpm -O /home/suporte/ksc-web-console-16.2.11309.x86_64.rpm\n")
time.sleep(5)
out = shell.recv(65536).decode('utf-8', errors='replace')
