...
print("Checking locate database...")
shell.send("locate klnagent | grep rpm\n")
time.sleep(2)
out = shell.recv(4096).decode('utf-8', errors='replace')
print("Locate:")
print(out)

print("Checking other temporary or storage folders...")
shell.send("find /var/tmp/ /mnt/ /media/ /opt/ -name '*.rpm' 2>/dev/null\n")
time.sleep(3)
out = shell.recv(65536).decode('utf-8', errors='replace')
print("Other folders search:")
print(out)
