...
def main():
    ...
    try:
        ...
        stdin, stdout, stderr = client.exec_command("ls -la /var/opt/kaspersky/ksc-web-console/server/")
        print("--- /var/opt/kaspersky/ksc-web-console/server/ ---")
        print(stdout.read().decode("utf-8"))

        # List files in /var/opt/kaspersky/ksc-web-console/
        stdin, stdout, stderr = client.exec_command("ls -la /var/opt/kaspersky/ksc-web-console/")
