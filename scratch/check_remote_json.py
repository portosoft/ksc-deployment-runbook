...
def main():
    ...
    try:
        ...
        stdin, stdout, stderr = client.exec_command("cat /etc/ksc-web-console-setup.json")
        ...
        stdin, stdout, stderr = client.exec_command("sudo systemctl status ksc-web-console")
