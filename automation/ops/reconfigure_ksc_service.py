...
"""
    ...
    # SECURITY: Prevent Predictable Temporary File Vulnerability (CWE-377/CWE-379)
    # Appending a random UUID prevents race conditions and symlink attacks in shared /tmp directory.
