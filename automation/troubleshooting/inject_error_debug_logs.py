...
def inject_error_debug_logs(host, user, password):
    ...
    try:
        ...
        content = content.replace("runtime.logger.info('DEBUG", "runtime.logger.error('DEBUG")
        ...
        client.exec_command(f"base64 -d /tmp/web-server-error.txt > /tmp/web-server-fixed.js")
