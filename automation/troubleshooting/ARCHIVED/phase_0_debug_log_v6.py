...
def phase_0_debug_log_v6(host, user, password):
    ...
    try:
        ...
        # CD and absolute path to node
        script_content = f"""#!/bin/bash
cd /var/opt/kaspersky/ksc-web-console
echo {password} | sudo -S /var/opt/kaspersky/ksc-web-console/node /var/opt/kaspersky/ksc-web-console/index.js > /tmp/ksc-console-debug.log 2>&1 &
"""
        ...
        print("Waiting 45 seconds for output (extended again)...")
        time.sleep(45)
...
if __name__ == "__main__":
    ...
    phase_0_debug_log_v6(host, user, password)
