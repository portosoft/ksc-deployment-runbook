...
def phase_0_debug_log_v7(host, user, password):
    ...
    try:
        ...
        # Use sudo -S bash -c "cd ... && ./node ./index.js"
        script_content = f"""#!/bin/bash
echo {password} | sudo -S bash -c "cd /var/opt/kaspersky/ksc-web-console && ./node ./index.js" > /tmp/ksc-console-debug.log 2>&1 &
"""
        ...
        print("Waiting 60 seconds for output (extended again)...")
        time.sleep(60)
...
if __name__ == "__main__":
    ...
    phase_0_debug_log_v7(host, user, password)
