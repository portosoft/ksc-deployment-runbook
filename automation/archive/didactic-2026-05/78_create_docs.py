...
docs = [
    ...
    "02-configuracao-env.md",
    "03-auditoria-previa.md",
    "04-postgres-setup.md",
    "05-selinux-hardening.md",
    "06-ksc-server-install.md",
    "07-web-console.md",
    "08-pos-install-hardening.md",
    "09-auditoria-final.md",
    "10-relatorios.md",
