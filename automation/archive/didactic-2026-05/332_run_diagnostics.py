...
def run_diagnostic_commands(client, commands, password, output_filepath):
...
def main():
    ...
    try:
        ...
        output_filepath = "scratch/diagnostic_raw_output.txt"

        run_diagnostic_commands(client, commands, password, output_filepath)
