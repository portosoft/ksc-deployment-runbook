...
print("Checking old opt and var_opt backups under recovery evidence configs...")
shell.send("find /root/ksc_recovery_evidence/configs/ -name '*.rpm'\n")
time.sleep(2)
out = shell.recv(65536).decode("utf-8", errors="replace")
print("RPMs in recovery evidence configs:")
print(out)
