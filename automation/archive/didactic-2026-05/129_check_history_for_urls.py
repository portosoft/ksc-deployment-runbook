...
print("Checking root .bash_history for klnagent and web-console urls...")
shell.send("grep -C 5 -iE 'klnagent|web-console' ~/.bash_history\n")
time.sleep(2)
out = shell.recv(65536).decode("utf-8", errors="replace")
print("Root history grepped:")
print(out)

print("Checking suporte .bash_history for klnagent and web-console urls...")
shell.send("grep -C 5 -iE 'klnagent|web-console' /home/suporte/.bash_history\n")
time.sleep(2)
out = shell.recv(65536).decode("utf-8", errors="replace")
print("Suporte history grepped:")
print(out)
