...
def run_sudo(cmd):
    ...
    if err and "senha para" not in err: print("STDERR:", err.encode('ascii', errors='replace').decode('ascii'))
...
try:
    ...
    run_sudo("ls -la /var/opt/kaspersky/klnagent_srv/iam || echo 'Diretorio nao existe'")
