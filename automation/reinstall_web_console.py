...
reinstall_cmds = [
    ...
    "rm -rf /etc/ksc-web-console-setup.json",
    "printf '{\"address\":\"" + secrets['KSC_FQDN'] + "\",\"port\":8080,\"trusted_cert\":\"\",\"defaultLanguageId\":\"pt-BR\",\"openAPIServers\":[{\"address\":\"" + secrets['KSC_FQDN'] + "\",\"port\":13000,\"openApiPort\":13299}]}' > /etc/ksc-web-console-setup.json",
