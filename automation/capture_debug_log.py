...
cmds = [
    "mv /tmp/plugins_backup/* /var/opt/kaspersky/ksc-web-console/server/plugins/ || true",
    "systemctl stop ksc-web-console",
    "bash -c 'cd /var/opt/kaspersky/ksc-web-console && nohup ./node index.js > /tmp/web_console_debug.log 2>&1 &'",
    "sleep 10",
    "cat /tmp/web_console_debug.log"
]
